...
FormRenderer.prototype.addField = function (field) {
    this.oFields[field._name] = _.cloneDeep(field._options);
 ...
 */
FormRenderer.prototype.addError = function (fieldName, error) {
    this.valid = false;
    if (typeof error == 'undefined') {
        error = fieldName;
        this.globalErrors = this.globalErrors || [ ];
        this.globalErrors.push(error);
    } else if (fieldName in this.oFields) {
        var field = this.oFields[fieldName];
 ...
 */
FormRenderer.prototype.errors = function (fieldName) {
    if (fieldName) {
        if (fieldName in this.oFields) {
            return this.oFields[fieldName].errors || [ ];
        }
        return null;
    }
